...
<body>
	<nav class="breadcrumb">
		...
		医疗问答管理 <span class="c-gray en">&gt;</span> 医疗问答列表 <a
	...
	<div class="page-container">
		<div class="text-c">
			...
			<input type="text" name="" id="" placeholder=" 医疗问答名称"
				style="width: 250px" class="input-text">
			<button name="" id="" class="btn btn-success" type="submit">
				<i class="Hui-iconfont">&#xe665;</i> 医疗问答
			</button>
		</div>
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
					批量删除</a> <a class="btn btn-primary radius" data-title="添加医疗问答"
				data-href="article-add.html" onclick="Hui_admin_tab(this)"
				href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加医疗问答</a></span>
		...
		<div class="mt-20">
			<form id="medicalQaForm" name="medicalQaForm"
				action="${pageContext.request.contextPath }/medicalQa/listMedicalQa"
				method=post>
				<table
					...
					<tbody>
						<c:forEach items="${medicalQaList }" var="medicalQa"
							varStatus="status">
							<tr class="text-c">
								<td><input type="checkbox" value="" name=""></td>
								<td>${status.index + 1}</td>
								<td>${medicalQa.qaId }</td>
								<td><a style="cursor: pointer" class="text-primary"
									href="${pageContext.request.contextPath }/medicalQa/showMedicalQa?qaId=${medicalQa.qaId }">${medicalQa.question }</a></td>
								<td class="f-14 td-manage"><a style="text-decoration: none"
									...
									onClick="article_edit('医疗问答编辑','article-add.html','10001')"
									href="${pageContext.request.contextPath }/medicalQa/detailedMedicalQa?qaId=${medicalQa.qaId }"
