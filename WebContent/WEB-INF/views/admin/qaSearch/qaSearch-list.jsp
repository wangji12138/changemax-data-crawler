...
<body>
	<nav class="breadcrumb">
		...
		问答搜索管理 <span class="c-gray en">&gt;</span> 问答搜索列表 <a
	...
	<div class="page-container">
		<div class="text-c">
			...
			<input type="text" name="" id="" placeholder=" 问答搜索名称"
				style="width: 250px" class="input-text">
			<button name="" id="" class="btn btn-success" type="submit">
				<i class="Hui-iconfont">&#xe665;</i> 问答搜索
			</button>
		</div>
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
					批量删除</a> <a class="btn btn-primary radius" data-title="添加问答搜索"
				data-href="article-add.html" onclick="Hui_admin_tab(this)"
				href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加问答搜索</a></span>
		...
		<div class="mt-20">
			<form id="qaSearchForm" name="qaSearchForm"
				action="${pageContext.request.contextPath }/qaSearch/listQaSearch"
				method=post>
				<table
					...
					<thead>
						<tr class="text-c">
							...
							<th width="250">ID</th>
							<th>问答搜索问题</th>
							<th width="150">问答搜索时间</th>
							<th width="120">操作</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach items="${qaSearchList }" var="qaSearch"
							varStatus="status">
							<tr class="text-c">
								<td><input type="checkbox" value="" name=""></td>
								<td>${status.index + 1}</td>
								<td>${qaSearch.id }</td>
								<td>${qaSearch.searchQuestion }</td>
								<td><fmt:formatDate value="${qaSearch.searchDate }"
								...
								<td class="f-14 td-manage"><a style="text-decoration: none"
									...
									onClick="article_edit('问答搜索编辑','article-add.html','10001')"
									href="${pageContext.request.contextPath }/qaSearch/detailedQaSearch?id=${qaSearch.id }"
