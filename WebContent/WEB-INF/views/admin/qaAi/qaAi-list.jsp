...
<body>
	<nav class="breadcrumb">
		...
		AI问答管理 <span class="c-gray en">&gt;</span> AI问答列表 <a
	...
	<div class="page-container">
		<div class="text-c">
			...
			<input type="text" name="" id="" placeholder=" AI问答名称"
				style="width: 250px" class="input-text">
			<button name="" id="" class="btn btn-success" type="submit">
				<i class="Hui-iconfont">&#xe665;</i> AI问答
			</button>
		</div>
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
					批量删除</a> <a class="btn btn-primary radius" data-title="添加AI问答"
				data-href="article-add.html" onclick="Hui_admin_tab(this)"
				href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加AI问答</a></span>
		...
		<div class="mt-20">
			<form id="qaAiForm" name="qaAiForm"
				action="${pageContext.request.contextPath }/qaAi/listQaAi"
				method=post>
				<table
					...
					<tbody>
						<c:forEach items="${qaAiList }" var="qaAi" varStatus="status">
							<tr class="text-c">
								...
								<td class="f-14 td-manage"><a style="text-decoration: none"
									...
									onClick="article_edit('AI问答编辑','article-add.html','10001')"
									href="${pageContext.request.contextPath }/qaAi/detailedQaAi?qaId=${qaAi.qaId }"
