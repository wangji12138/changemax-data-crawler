...
<![endif]-->
<title>BDZD问答列表</title>
</head>
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>
		BDZD问答管理 <span class="c-gray en">&gt;</span> BDZD问答列表 <a
	...
	<div class="page-container">
		<div class="text-c">
			...
			<input type="text" name="" id="" placeholder=" BDZD问答名称"
				style="width: 250px" class="input-text">
			<button name="" id="" class="btn btn-success" type="submit">
				<i class="Hui-iconfont">&#xe665;</i> BDZD问答
			</button>
		</div>
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
					批量删除</a> <a class="btn btn-primary radius" data-title="添加BDZD问答"
				data-href="article-add.html" onclick="Hui_admin_tab(this)"
				href="javascript:;"><i class="Hui-iconfont">&#xe600;</i>
					添加BDZD问答</a></span> <span class="r">共有数据：<strong>${pageModel.getRecordCount() }</strong>
				条，<span class="r">共有：<strong>${pageModel.getTotalSize() }</strong>
					页
			</span>
		</div>
		<div class="mt-20">
			<form id="bdzdQaForm" name="bdzdQaForm"
				action="${pageContext.request.contextPath }/bdzdQa/listMedicalQa"
				method=post>
				<table
					...
					<tbody>
						<c:forEach items="${bdzdQaList }" var="bdzdQa" varStatus="status">
							<tr class="text-c">
								<td><input type="checkbox" value="" name=""></td>
								<td>${status.index + 1}</td>
								<td><a style="cursor: pointer" class="text-primary"
									href="${pageContext.request.contextPath }/bdzdQa/showMedicalQa?url=${bdzdQa.url }">${bdzdQa.question }</a></td>
								<td class="f-14 td-manage"><a style="text-decoration: none"
									...
									onClick="article_edit('BDZD问答编辑','article-add.html','10001')"
									href="${pageContext.request.contextPath }/bdzdQa/detailedMedicalQa?url=${bdzdQa.url }"
