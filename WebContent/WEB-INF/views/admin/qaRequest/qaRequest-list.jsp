...
<body>
	<nav class="breadcrumb">
		...
		问答请求管理 <span class="c-gray en">&gt;</span> 问答请求列表 <a
	...
	<div class="page-container">
		<div class="text-c">
			...
			<input type="text" name="" id="" placeholder=" 问答请求名称"
				style="width: 250px" class="input-text">
			<button name="" id="" class="btn btn-success" type="submit">
				<i class="Hui-iconfont">&#xe665;</i> 问答请求
			</button>
		</div>
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
					批量删除</a> <a class="btn btn-primary radius" data-title="添加问答请求"
				data-href="article-add.html" onclick="Hui_admin_tab(this)"
				href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加问答请求</a></span>
		...
		<div class="mt-20">
			...
			<c:choose>
				<c:when test="${qaRequestList!=null }">

					<form id="qaRequestForm" name="qaRequestForm"
						action="${pageContext.request.contextPath }/qaRequest/listQaRequest"
						method=post>
						<table
							...
							<thead>
								<tr class="text-c">
									...
									<th width="40">序号</th>
									<th width="250">问答请求ID</th>
									<th width="250">问答用户ID</th>
									<th width="250">问答请求文本ID</th>
									<th width="120">操作</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${qaRequestList }" var="qaRequest"
									varStatus="status">
									<tr class="text-c">
										<td><input type="checkbox" value="" name=""></td>
										<td>${status.index + 1}</td>
										<td>${qaRequest.qaRequestId }</td>
										<td><a
											href="${pageContext.request.contextPath }/user/showUser?userId=${qaRequest.qaRequestUserId }">${qaRequest.qaRequestUserId }</a></td>
										<td><a
											href="${pageContext.request.contextPath }/text/showText?textId=${qaRequest.textId }">${qaRequest.textId }</a></td>
										...
										<td class="f-14 td-manage"><a
											...
											class="ml-5"
											onClick="article_edit('问答请求编辑','article-add.html','10001')"
											href="${pageContext.request.contextPath }/qaRequest/detailedQaRequest?id=${qaRequest.id }"
