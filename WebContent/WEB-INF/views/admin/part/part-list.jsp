...
<body>
	<nav class="breadcrumb">
		...
		人体部位管理 <span class="c-gray en">&gt;</span> 人体部位列表 <a
	...
	<div class="page-container">
		<div class="text-c">
			...
			</span> <input type="text" name="" id="" placeholder=" 人体部位名称"
				style="width: 250px" class="input-text">
			<button name="" id="" class="btn btn-success" type="submit">
				<i class="Hui-iconfont">&#xe665;</i> 人体部位
			</button>
		</div>
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
					批量删除</a> <a class="btn btn-primary radius" data-title="添加人体部位"
				data-href="article-add.html" onclick="Hui_admin_tab(this)"
				href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加人体部位</a></span>
		...
		<div class="mt-20">
			...
			<form id="partForm" name="partForm"
				action="${pageContext.request.contextPath }/part/listPart"
				method=post>
				<table
						...
						<c:forEach items="${partList }" var="part" varStatus="status">
							<tr class="text-c">
								...
								<td><a style="cursor: pointer" class="text-primary"
									href="${pageContext.request.contextPath }/part/showPart?partId=${part.partId }">${part.partName }</a></td>
								<td class="f-14 td-manage"><a style="text-decoration: none"
									...
									onClick="article_edit('人体部位编辑','article-add.html','10001')"
									href="${pageContext.request.contextPath }/part/detailedPart?partId=${part.partId }"
