...
<body>
	<nav class="breadcrumb">
		...
		医疗视频管理 <span class="c-gray en">&gt;</span> 医疗视频列表 <a
	...
	<div class="page-container">
		<div class="text-c">
			...
			<input type="text" name="" id="" placeholder=" 医疗视频名称"
				style="width: 250px" class="input-text">
			<button name="" id="" class="btn btn-success" type="submit">
				<i class="Hui-iconfont">&#xe665;</i> 医疗视频
			</button>
		</div>
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
					批量删除</a> <a class="btn btn-primary radius" data-title="添加医疗视频"
				data-href="article-add.html" onclick="Hui_admin_tab(this)"
				href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加医疗视频</a></span>
		...
		<div class="mt-20">
			<form id="medicalVideoForm" name="medicalVideoForm"
				action="${pageContext.request.contextPath }/medicalVideo/listMedicalVideo"
				method=post>
				<table
					...
					<tbody>
						<c:forEach items="${medicalVideoList }" var="medicalVideo"
							varStatus="status">
							<tr class="text-c">
								<td><input type="checkbox" value="" name=""></td>
								<td>${status.index + 1}</td>
								<td>${medicalVideo.videoId }</td>
								<td><a style="cursor: pointer" class="text-primary"
									href="${pageContext.request.contextPath }/medicalVideo/showMedicalVideo?videoId=${medicalVideo.videoId }">${medicalVideo.videoTitle }</a></td>
								<td class="f-14 td-manage"><a style="text-decoration: none"
									...
									onClick="article_edit('医疗视频编辑','article-add.html','10001')"
									href="${pageContext.request.contextPath }/medicalVideo/detailedMedicalVideo?videoId=${medicalVideo.videoId }"
	...
	<script type="text/javascript">
		function to_page(pageIndex) {
			...
			document.medicalVideoForm.submit();
		}
	</script>
</body>
</html>