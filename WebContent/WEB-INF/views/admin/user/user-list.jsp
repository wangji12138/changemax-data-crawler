...
<body>
	...
	<div class="page-container">
		<div class="text-c">
			...
			<input type="text" name="" id="" placeholder=" 用户名称"
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
					批量删除</a> <a class="btn btn-primary radius" data-title="添加用户"
		...
		<div class="mt-20">
			<form id="userForm" name="userForm"
				action="${pageContext.request.contextPath }/user/listUser"
				method=post>
				<table
					...
					<tbody>
						<c:forEach items="${userList }" var="user" varStatus="status">
							<tr class="text-c">
								...
								<td><fmt:formatDate value="${user.userRegistrationTime }"
								...
								<td class="f-14 td-manage"><a style="text-decoration: none"
									...
									href="${pageContext.request.contextPath }/user/detailedUser?userId=${user.userId }"
