...
<body>
	<form id="qaAiForm" name="qaAiForm"
		action="${pageContext.request.contextPath }/qaAi/listQa" method=post>
				...
				<tr>
					...
					<td vAlign=top width="100%" bgColor=#ffffff>
						<table cellSpacing=0 cellPadding=5 width="100%" border=0>
							<tr>
								<td class=manageHead>当前位置：AI问答 &gt; AI问答列表</td>
							</tr>
							<tr>
								<td height=2></td>
							</tr>
											...
											<c:when test="${qaAiList!=null }">
												<table id=grid
													...
													<tbody>
														...
														<c:forEach items="${qaAiList }" var="qaAi">
															<tr
