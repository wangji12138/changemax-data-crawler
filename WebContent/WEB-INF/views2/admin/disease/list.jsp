				...
				<tr>
					...
					<td vAlign=top width="100%" bgColor=#ffffff>
						<table cellSpacing=0 cellPadding=5 width="100%" border=0>
							<tr>
								<td class=manageHead>当前位置：疾病 &gt; 疾病列表</td>
							</tr>
							<tr>
								<td height=2></td>
							</tr>
													...
													<tbody>
														...
														<c:forEach items="${diseaseList }" var="disease">
															<tr
																...
																<td><a
																	href="${pageContext.request.contextPath }/disease/detailedDisease?diseaseId=${disease.diseaseId}">${disease.diseaseName }</a></td>
															</tr>
														</c:forEach>
													</tbody>
												</table>
