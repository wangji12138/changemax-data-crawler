				...
				<tr>
					...
					<td vAlign=top width="100%" bgColor=#ffffff>
						<table cellSpacing=0 cellPadding=5 width="100%" border=0>
							<tr>
								<td class=manageHead>当前位置：医疗问答 &gt; 医疗问答列表</td>
							</tr>
							<tr>
								<td height=2></td>
							</tr>
						...
						<table borderColor=#cccccc cellSpacing=0 cellPadding=0
							...
							<tbody>
								...
								<tr>
									<td><c:choose>
											<c:when test="${medicalQaList!=null }">
												<table id=grid
													...
													<tbody>
														...
														<c:forEach items="${medicalQaList }" var="medicalQa">
															<tr
																...
																<td><a
																	href="${pageContext.request.contextPath }/medicalQa/detailedMedicalQa?qaId=${medicalQa.qaId}">${medicalQa.question }</a></td>
															</tr>
														</c:forEach>
													</tbody>
												</table>
