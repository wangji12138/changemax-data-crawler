				...
				<tr>
					...
					<td vAlign=top width="100%" bgColor=#ffffff>
						<table cellSpacing=0 cellPadding=5 width="100%" border=0>
							<tr>
								<td class=manageHead>当前位置：医疗视频 &gt; 医疗视频列表</td>
							</tr>
							<tr>
								<td height=2></td>
							</tr>
						...
						<table borderColor=#cccccc cellSpacing=0 cellPadding=0
							...
							<tbody>
								...
								<tr>
									<td><c:choose>
											<c:when test="${medicalVideoList!=null }">
												<table id=grid
													...
													<tbody>
														...
														<c:forEach items="${medicalVideoList }" var="medicalVideo">
															<tr
																...
																<td><a
																	href="${pageContext.request.contextPath }/medicalVideo/detailedMedicalVideo?videoId=${medicalVideo.videoId}">${medicalVideo.videoTitle }</a></td>
															</tr>
														</c:forEach>
													</tbody>
												</table>
