...
<body>
	<form id="qaForm" name="qaForm"
		action="${pageContext.request.contextPath }/qa/listQa" method=post>
													...
													<tbody>
														...
														<c:forEach items="${qaList }" var="qa">
															<tr
																...
																<td>${qa.analysisType }</td>
																<td>${qa.question }</td>
																<td><a
																	href="${pageContext.request.contextPath }/qa/detailedQa?id=${qa.id}">${qa.originalQuestion }</a></td>
																<td>${qa.similarity }</td>
															</tr>
														</c:forEach>
													</tbody>
