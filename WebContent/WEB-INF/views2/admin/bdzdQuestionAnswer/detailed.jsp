...
<meta charset="UTF-8">
<title><c:choose>
		<c:when test="${bdzdQuestionAnswer!=null }">${bdzdQuestionAnswer.question }_changeMax问答</c:when>
			...
			<tr>
				...
				<td vAlign=top width="100%" bgColor=#ffffff>
					<table cellSpacing=0 cellPadding=5 width="100%" border=0>
						<tr>
							<td class=manageHead>当前位置：问答 &gt; 问答详细</td>
						</tr>
						<tr>
							<td height=2></td>
						</tr>
					...
					<table borderColor=#cccccc cellSpacing=0 cellPadding=0 width="100%"
						...
						<tbody>
							<tr>
								<td><c:choose>
										<c:when test="${bdzdQuestionAnswer!=null }">
											<table id=grid
												...
												<tbody>
													<tr
														...
														<td><a href="${bdzdQuestionAnswer.url }">${bdzdQuestionAnswer.question }</a></td>
														<td>${bdzdQuestionAnswer.answer }</td>
														<td>${bdzdQuestionAnswer.answerTime }</td>
														<td>${bdzdQuestionAnswer.clickHeat }</td>
													</tr>
												</tbody>
											</table>
										</c:when>
