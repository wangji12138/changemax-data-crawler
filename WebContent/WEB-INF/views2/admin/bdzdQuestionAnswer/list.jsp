...
<script language=javascript>
	function to_page(pageIndex) {
		...
		document.bdzdQuestionAnswerForm.submit();
	}
</script>
<meta content="MSHTML 6.00.2900.3492" name=GENERATOR>
</head>
<body>
	<form id="bdzdQuestionAnswerForm" name="bdzdQuestionAnswerForm"
		action="${pageContext.request.contextPath }/bdzdQuestionAnswer/listBdzdQuestionAnswer"
		method=post>
				...
				<tr>
					...
					<td vAlign=top width="100%" bgColor=#ffffff>
						<table cellSpacing=0 cellPadding=5 width="100%" border=0>
							<tr>
								<td class=manageHead>当前位置：问答 &gt; 问答列表</td>
							</tr>
							<tr>
								<td height=2></td>
							</tr>
						...
						<table borderColor=#cccccc cellSpacing=0 cellPadding=0
							...
							<tbody>
								...
								<tr>
									<td><c:choose>
											<c:when test="${bdzdQuestionAnswerList!=null }">
												<table id=grid
													...
													<tbody>
														...
														<c:forEach items="${bdzdQuestionAnswerList }"
															var="bdzdQuestionAnswer">
															<tr
																style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">

																<td><a
																	href="${pageContext.request.contextPath }/bdzdQuestionAnswer/detailedBdzdQuestionAnswer?url=${bdzdQuestionAnswer.url}">${bdzdQuestionAnswer.question }</a></td>
															</tr>
														</c:forEach>
													</tbody>
												</table>
