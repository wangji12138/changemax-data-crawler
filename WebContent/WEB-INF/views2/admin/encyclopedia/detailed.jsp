...
<meta charset="UTF-8">
<title><c:choose>
		<c:when test="${encyclopedia!=null }">${encyclopedia.name } _changeMax百科</c:when>
			...
			<tr>
				...
				<td vAlign=top width="100%" bgColor=#ffffff>
					<table cellSpacing=0 cellPadding=5 width="100%" border=0>
						<tr>
							<td class=manageHead>当前位置：百科 &gt; 百科详细</td>
						</tr>
						<tr>
							<td height=2></td>
						</tr>
											...
											<table id=grid
												...
												<tbody>
													<tr
														...
														<td>${encyclopedia.name }</td>
														<td>${encyclopedia.introduction }</td>
													</tr>
												</tbody>
											</table>
										</c:when>
