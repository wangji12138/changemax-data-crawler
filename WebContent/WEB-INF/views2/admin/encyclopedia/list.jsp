				...
				<tr>
					...
					<td vAlign=top width="100%" bgColor=#ffffff>
						<table cellSpacing=0 cellPadding=5 width="100%" border=0>
							<tr>
								<td class=manageHead>当前位置：百科 &gt; 百科列表</td>
							</tr>
							<tr>
								<td height=2></td>
							</tr>
						...
						<table borderColor=#cccccc cellSpacing=0 cellPadding=0
							...
							<tbody>
								...
								<tr>
									<td><c:choose>
											<c:when test="${encyclopediaList!=null }">
												<table id=grid
													...
													<tbody>
														...
														<c:forEach items="${encyclopediaList }" var="encyclopedia">
															<tr
																...
																<td><a
																	href="${pageContext.request.contextPath }/encyclopedia/detailedEncyclopedia?id=${encyclopedia.id}&name=${encyclopedia.name}&url=${encyclopedia.url}">${encyclopedia.name }</a></td>
															</tr>
														</c:forEach>
													</tbody>
												</table>
