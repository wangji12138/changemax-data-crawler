				...
				<tr>
					...
					<td vAlign=top width="100%" bgColor=#ffffff>
						<table cellSpacing=0 cellPadding=5 width="100%" border=0>
							<tr>
								<td class=manageHead>当前位置：器官 &gt; 器官列表</td>
							</tr>
							<tr>
								<td height=2></td>
							</tr>
													...
													<tbody>
														...
														<c:forEach items="${organList }" var="organ">
															<tr
																...
																<td><a
																	href="${pageContext.request.contextPath }/organ/detailedOrgan?organId=${organ.organId}">${organ.organName }</a></td>
															</tr>
														</c:forEach>
													</tbody>
												</table>
