				...
				<tr>
					...
					<td vAlign=top width="100%" bgColor=#ffffff>
						<table cellSpacing=0 cellPadding=5 width="100%" border=0>
							<tr>
								<td class=manageHead>当前位置：问答搜索 &gt; 问答搜索列表</td>
							</tr>
							<tr>
								<td height=2></td>
							</tr>
													...
													<tbody>
														...
														<c:forEach items="${qaSearchList }" var="qaSearch">
															<tr
																...
																<td>${qaSearch.searchDate }</td>
																<td><a
																	href="${pageContext.request.contextPath }/qaSearch/editQaSearch?id=${qaSearch.id}">修改</a>
																	&nbsp;&nbsp; <a
																	href="${pageContext.request.contextPath }/qaSearch/deleteQaSearch?id=${qaSearch.id}">删除</a>
																</td>
															</tr>
														</c:forEach>
													</tbody>
