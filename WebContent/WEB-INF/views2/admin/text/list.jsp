...
<body>
	<form id="textForm" name="textForm"
		action="${pageContext.request.contextPath }/text/listText" method=post>
				...
				<tr>
					...
					<td vAlign=top width="100%" bgColor=#ffffff>
						<table cellSpacing=0 cellPadding=5 width="100%" border=0>
							<tr>
								<td class=manageHead>当前位置：文本 &gt; 文本列表</td>
							</tr>
							<tr>
								<td height=2></td>
							</tr>
													...
													<tbody>
														...
														<c:forEach items="${textList }" var="text">
															<tr
																...
																<td><a
																	href="${pageContext.request.contextPath }/text/detailedText?id=${text.id}">${text.textContent }</a></td>
															</tr>
														</c:forEach>
													</tbody>
												</table>
