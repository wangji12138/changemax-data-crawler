...
import cn.changemax.mas.service.DocumentService;
...
public class DocumentController {
	...
	@RequestMapping("/goFileUpAndDown")
	public String fileUpAndDown() {
		return "/admin/document/FileUpAndDown";
	}
	...
	public String testUpload(HttpServletRequest request, Model model,
		...
		String realPath = servletContext.getRealPath("/upload");// 得到文件上传目的位置的真实路径
		...
		// 开始文件转换
		String conversionFileName = documentService.convert2PDF(fileName);
